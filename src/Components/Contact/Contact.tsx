import {
  ...
  export default function Contact() {
    ...
    const { hasCopied, onCopy } = useClipboard('matt.szczerba55@gmail.com');   
              ...
              <Box
                ...
                <VStack spacing={5}>
                  ...
                  <FormControl isRequired>
                    ...
                    <Textarea name="message" placeholder="Your Message" rows={6} resize="none" onChange={(e) => setMessage(e.target.value)}  />
                  </FormControl> 
                  <Button
                    _hover={{
                      bg: '#f56565',
